document.addEventListener('DOMContentLoaded', function () {
  ...
  function getRequiredMessage(fieldName) {
    const readable = fieldName.replace(/[-_]/g, ' ').replace(/\b\w/g, function (c) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ąb.com משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '522dc186-9214-4567-8b31-2f96e25a33fc',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '522dc186-9214-4567-8b31-2f96e25a33fc';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '522dc186-9214-4567-8b31-2f96e25a33fc';
